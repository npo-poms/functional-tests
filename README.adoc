...
[NOTE]
====
So this project now only contains the 'fitnesse' tests, and should focus on testing the _GUI_. End-to-end integration tests are maintained in https://git.vpro.nl/npo/test/api-tests[git.vpro.nl]

We also don't use jenkins anymore. This document is outdated!
====
