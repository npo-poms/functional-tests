This is the test automation project of [Specialisterren](https://www.specialisterren.nl/) for [the test environment](https://poms-test.omroep.nl/) and [the dev environment](https://poms-dev.omroep.nl/) of NPO POMS.
