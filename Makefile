...
run:  ${JAR} ${NAME}
	docker run --rm -e MOZ_HEADLESS=1 ${DOCKER_ARGS_RUN}  mvn failsafe:integration-test -DfitnesseSuiteToRun=NpoPoms.Omgevingen.Test.TestScripts.Gui -DseleniumJsonProfile={'args':['headless','disable-gpu']}
